...
<body>
    <header>
        <a class="logo" href="${pageContext.request.contextPath}/index">
            <img src="../static/images/logo.png" alt="logo" style="width: 50px; height: 50px;">
    ...
    <main class="admin">
        ...
        <div class="regevento">
            <div class="input-box">
                ...
                <form class="form" action="${pageContext.request.contextPath}/admin" method="post">
                    <input type="text" id="EventoName" name="EventoName" placeholder="Nome do Evento" required>
                    <input type="date" id="EventoDate" name="EventoDate" required>
        ...
        <div class="regtempo">
            <div class="input-box">
                ...
                <form class="form" action="${pageContext.request.contextPath}/admin" method="post">
                    <input type="text" name="EventoID" placeholder="Id do Evento" required>
                    <input type="text" name="EventoDorsal" placeholder="Nº do Dorsal" required>
